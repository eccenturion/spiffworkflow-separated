...
# Nuevas variables para controlar la separación de servicios
SPIFFWORKFLOW_BACKEND_RUN_API_ENDPOINTS = config_from_env(
    "SPIFFWORKFLOW_BACKEND_RUN_API_ENDPOINTS", default=True
)

# Configuración específica para PostgreSQL
if SPIFFWORKFLOW_BACKEND_DATABASE_TYPE == "postgres":
    SQLALCHEMY_ENGINE_OPTIONS = {
        "pool_pre_ping": True,
        "pool_recycle": 300,
        "connect_args": {
            "connect_timeout": 10,
            "application_name": "spiffworkflow_backend"
        }
    }